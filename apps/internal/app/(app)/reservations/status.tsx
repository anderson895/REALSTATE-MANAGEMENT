...
const TONES: Record<ReservationStatus, string> = {
  ...
  PaymentVerified: 'bg-sky-50 text-sky-700 ring-sky-600/20 dark:bg-sky-950 dark:text-sky-300',
  DocumentsVerified: 'bg-sky-50 text-sky-700 ring-sky-600/20 dark:bg-sky-950 dark:text-sky-300',
  // Settled favourably.
  Approved:
  ...
  Cancelled: 'bg-rose-50 text-rose-700 ring-rose-600/20 dark:bg-rose-950 dark:text-rose-300',
};
        ...
        return (
          <li key={label} className="flex items-center gap-2">
            ...
            {index < STAGE_LABELS.length - 1 ? (
              <span aria-hidden="true" className="mx-1 h-px w-6 bg-neutral-200 dark:bg-neutral-800" />
            ) : null}
          </li>
        );
      })}
